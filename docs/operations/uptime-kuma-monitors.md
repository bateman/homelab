...
| Portainer | HTTP(s) | `https://portainer:9443/` | Monitor primario (nessun Docker healthcheck — immagine scratch senza wget/curl); abilitare "Ignore TLS/SSL errors"; accettare codici 200-399 ("Accepted Status Codes") poiché la root può restituire un redirect 303 |
