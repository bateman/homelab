...
| Portainer | HTTP(s) | `https://portainer:9443/` | Primary health monitor (no Docker healthcheck — scratch image has no wget/curl); enable "Ignore TLS/SSL errors"; accept status codes 200-399 since root may return a 303 redirect |
